...
def initialize_quality_system():
    ...
    socket.bind("tcp://*:5552")  # Bind to the address for the quality system

    print("Starting quality system in the fog layer...")
...
def process_alerts(socket):
    try:
        while True:
            ...
            # Send acknowledgment back to the proxy system
